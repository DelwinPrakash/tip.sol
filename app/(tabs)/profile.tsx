...
import { Alert, Keyboard, RefreshControl, ScrollView, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
...
export default function ProfileScreen() {
    ...
    useEffect(() => {
        if (userProfile) {
            ...
            setSelectAvatar(userProfile.avatarUri);
            setIsEditing(false);
            ...
            <TouchableWithoutFeedback onPress={() => {
                ...
                <View style={{ position: 'relative', zIndex: 10, flex: 1 }}>
                    ...
                    <View style={{ alignItems: 'center', marginBottom: 30 }}>
                        <View style={{ width: 100, height: 100, borderRadius: 50, backgroundColor: theme.card, justifyContent: 'center', alignItems: 'center', marginBottom: 10, elevation: 5, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 5 }}>
                    ...
                    {isEditing ? (
                        <View>
                            ...
                            <TextInput
                                ...
                                style={{ borderWidth: 1, borderColor: theme.border, padding: 15, borderRadius: 10, marginBottom: 15, color: theme.text, backgroundColor: theme.background, fontSize: 16 }}
                            ...
                            <TextInput
                                value={bio}
                                onChangeText={setBio}
                                style={{ borderWidth: 1, borderColor: theme.border, padding: 15, borderRadius: 10, marginBottom: 15, color: theme.text, backgroundColor: theme.background, fontSize: 16, minHeight: 100, textAlignVertical: 'top' }}
                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    setAvatarUri(selectAvatar)
                                    setIsEditing(false);
                                }}
                                style={{ backgroundColor: theme.background, padding: 15, borderRadius: 10, alignItems: 'center' }}
                            >
